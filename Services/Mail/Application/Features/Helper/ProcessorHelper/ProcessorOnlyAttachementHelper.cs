...
//{
//    public static class ProcessorOnlyAttachementHelper
//    {
...
//        public static void save_pdf_and_images_for_online_attachement(MimeMessage message, string directorypath, MailRule mail, string title, List<Application.Consumers.RestAPIDocuments.Dtos.Document> documents, string tessDataPath, Guid corr_id, HttpClient http)
//        {
...
//                {
//                    Adding_documents_only_process_attachement(message, directorypath, mail, title, documents, tessDataPath, corr_id, attachment, document, http);
//                }
...
//        }
//        public static async void save_eml_files_for_online_attachement(MimeMessage message, string directorypath, MailRule mail, string title, List<Application.Consumers.RestAPIDocuments.Dtos.Document> documents, UniqueId uid, Guid corr_id, HttpClient http)
//        {
//            Application.Consumers.RestAPIDocuments.Dtos.Document document = new Application.Consumers.RestAPIDocuments.Dtos.Document();
...
//        public static async void Adding_documents_only_process_attachement(MimeMessage message, string directorypath, MailRule mail, string title, List<Application.Consumers.RestAPIDocuments.Dtos.Document> documents, string tessDataPath, Guid corr_id, MimeEntity attachment, Application.Consumers.RestAPIDocuments.Dtos.Document document, HttpClient http)
//        {
...
////        public static void save_pdf_and_images_for_online_attachement(MimeMessage message, string directorypath, MailRule mail, string title, List<Application.Consumers.RestAPIDocuments.Dtos.Document> documents, string tessDataPath, Guid corr_id)
////        {
////            Application.Consumers.RestAPIDocuments.Dtos.Document document = new Application.Consumers.RestAPIDocuments.Dtos.Document();
////            foreach (var attachment in message.Attachments)
////            {
...
////                if (!string.IsNullOrEmpty(mail.Filter_attachment_filename) && AttachmentUtilities.MatchWildcard(attachment.ContentType.Name, mail.Filter_attachment_filename))
////                {
////                    Adding_documents_only_process_attachement(message, directorypath, mail, title, documents, tessDataPath, corr_id, attachment, document);
////                }
////                //in case we don't specify a filter_filename
////                else if (string.IsNullOrEmpty(mail.Filter_attachment_filename))
////                {
...
////        }
////        public static void save_eml_files_for_online_attachement(MimeMessage message, string directorypath, MailRule mail, string title, List<Application.Consumers.RestAPIDocuments.Dtos.Document> documents, UniqueId uid, Guid corr_id)
////        {
////            Application.Consumers.RestAPIDocuments.Dtos.Document document = new Application.Consumers.RestAPIDocuments.Dtos.Document();
////            if (message.BodyParts.OfType<MimePart>().Any(part => part.IsAttachment == false))
////            {
...
////        public static async void Adding_documents_only_process_attachement(MimeMessage message, string directorypath, MailRule mail, string title, List<Application.Consumers.RestAPIDocuments.Dtos.Document> documents, string tessDataPath, Guid corr_id, MimeEntity attachment, Application.Consumers.RestAPIDocuments.Dtos.Document document)
////        {
////            if (attachment is MimePart mimePart && mimePart.IsAttachment == true)
////            {
////                if (mimePart.ContentType.MediaSubtype == "plain")
